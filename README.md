...
* **Pass‑Bundle Limit.** The original algorithm dedicates 1/ε^6 PASS‑BUNDLES per phase. We fix this to 10 to avoid infinite loops and rule violations (e.g., vertices with multiple incident path edges).  
